...
Check whether repository engineering standards are defined in `agent.md`.
...
If `agent.md` is not present, infer standards from existing repository code patterns.
